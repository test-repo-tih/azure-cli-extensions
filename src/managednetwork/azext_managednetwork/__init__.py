...
from azext_managednetwork._help import helps  # pylint: disable=unused-import
...
class ManagedNetworkCommandsLoader(AzCommandsLoader):
    ...
    def __init__(self, cli_ctx=None):
        ...
        from azext_managednetwork._client_factory import cf_managednetwork
    ...
    def load_arguments(self, command):
        from azext_managednetwork._params import load_arguments
