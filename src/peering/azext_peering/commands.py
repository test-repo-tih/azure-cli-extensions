...
def load_command_table(self, _):
    ...
    peering_peer_asns = CliCommandType(
        operations_tmpl='azure.mgmt.peering.operations.peer_asns_operations#PeerAsnsOperations.{}',
    ...
    peering_peerings = CliCommandType(
        operations_tmpl='azure.mgmt.peering.operations.peerings_operations#PeeringsOperations.{}',
    ...
    peering_prefixes = CliCommandType(
        operations_tmpl='azure.mgmt.peering.operations.prefixes_operations#PrefixesOperations.{}',
    ...
    peering_peering_services = CliCommandType(
        operations_tmpl='azure.mgmt.peering.operations.peering_services_operations#PeeringServicesOperations.{}',
